...
class IkametClient:
    ...
    def get_ikamet_result(self,
        ...
        request_data = IkametRequest(basvuru_no=application_id, cep_telefon=phone_number, e_posta=phone_number,
                                     yabanci_kimlik_no=turkish_id_number, pasaport_belge_no=foreign_passport_number,
                                     islem_tur=-1, captcha_de_text=captcha_text, captcha_input_text=captcha_id)
